...
\newcommand\wellformed[1]{#1 \; \text{well-formed}}
...
\begin{document}
  ...
  \begin{figure}
    \begin{mdframed}[backgroundcolor=none]
      \begin{center}
        \framebox{$\wellformed{\emmap{\effect}{\anno{\evar}{\type}}}$}
      \end{center}
      ...
      \begin{prooftree}
          ...
          \AxiomC{$\hastype{\context_0}{\type}{\krow}$}
        \RightLabel{(\textsc{WF-Unit})}
        \BinaryInfC{$\wellformed{\emmap{\effect}{\anno{\evar}{\twitht{\tunit}{\type}}}}$}
      \end{prooftree}

      \begin{prooftree}
          \AxiomC{$\wellformed{\emmap{\effect}{\anno{\evar}{\type_2}}}$}
          \AxiomC{$\hastype{\context_0}{\type_1}{\ktwitht}$}
          \AxiomC{$\hastype{\context_0}{\type_2}{\ktwitht}$}
        \RightLabel{(\textsc{WF-Arrow})}
        \TrinaryInfC{$\wellformed{\emmap{\effect}{\anno{\evar}{\twitht{\parens{\tarrow{\type_1}{\type_2}}}{\tempty}}}}$}
      \end{prooftree}

      \begin{prooftree}
          \AxiomC{$\wellformed{\emmap{\effect}{\anno{\evar}{\type}}}$}
          \AxiomC{$\hastype{\cextend{\context_0}{\anno{\tvar}{\kind}}}{\type}{\ktwitht}$}
        \RightLabel{(\textsc{WF-ForAll})}
        \BinaryInfC{$\wellformed{\emmap{\effect}{\anno{\evar}{\twitht{\parens{\tforall{\anno{\tvar}{\kind}}{\type}}}{\tempty}}}}$}
      \end{prooftree}
