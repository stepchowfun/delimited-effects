  ...
  \begin{figure}
    \begin{mdframed}[backgroundcolor=none]
      ...
      \begin{prooftree}
        ...
        \TrinaryInfC{$\hastype{\context}{\eapp{\term_2}{\term_1}}{\twitht{\type_3}{\runion{\type_4}{\type_5}}}$}
      \end{prooftree}
      ...
      \begin{prooftree}
        ...
        \QuaternaryInfC{$\hastype{\context}{\eprovide{\effect}{\term_1}{\term_2}}{\twitht{\type_2}{\rdiff{\type_3}{\rsingleton{\effect}}}}$}
      \end{prooftree}
