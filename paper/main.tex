      ...
      \begin{figure}[H]
        \begin{mdframed}[backgroundcolor=none]
          ...
          \begin{prooftree}
              ...
              \AxiomC{$\checkType{\context}{\effectMap}{\term_2}{\type_2}{\rUnion{\row_2}{\row_4}}$}
            \RightLabel{(\textsc{T-App})}
            \BinaryInfC{$\inferType{\context}{\effectMap}{\eApp{\term_1}{\term_2}}{\type_1}{\rUnion{\rUnion{\row_1}{\row_3}}{\row_4}}$}
          \end{prooftree}
          ...
          \begin{prooftree}
            ...
            \UnaryInfC{$\inferType{\context}{\effectMap}{\eTApp{\term}{\type_2}}{\substitute{\type_1}{\tVar}{\type_2}}{\rUnion{\row_1}{\row_2}}$}
          \end{prooftree}
