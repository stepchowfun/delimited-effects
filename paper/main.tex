    ...
    \subsection{Syntax and semantics}
      ...
      \begin{figure}[H]
        \begin{mdframed}[backgroundcolor=none]
          ...
          \begin{prooftree}
            \AxiomC{$\hastype{\context}{\term}{\tembellished{\parens{\tforall{\rvar}{\tembellished{\proper}{\row_2}{}}}}{\rempty}{\rempty}}$}
            \RightLabel{(\textsc{T-RowApplication})}
            \UnaryInfC{$\hastype{\context}{\etapp{\term}{\row_1}}{\substitute{\tembellished{\proper}{\row_2}{\rempty}}{\rvar}{\row_1}}$}
          \end{prooftree}
