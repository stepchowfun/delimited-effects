  ...
  \begin{figure}
    \begin{mdframed}[backgroundcolor=none]
      ...
      \begin{prooftree}
        ...
        \UnaryInfC{$\wellformed{\emmap{\effect}{\anno{\evar}{\twitht{\tunit}{\type}}}}$}
      \end{prooftree}

      \begin{prooftree}
          \AxiomC{$\wellformed{\emmap{\effect}{\anno{\evar}{\type_2}}}$}
        \RightLabel{(\textsc{WF-Arrow})}
        \UnaryInfC{$\wellformed{\emmap{\effect}{\anno{\evar}{\twitht{\parens{\tarrow{\type_1}{\type_2}}}{\tempty}}}}$}
      \end{prooftree}

      \begin{prooftree}
          \AxiomC{$\wellformed{\emmap{\effect}{\anno{\evar}{\type}}}$}
        \RightLabel{(\textsc{WF-ForAll})}
        \UnaryInfC{$\wellformed{\emmap{\effect}{\anno{\evar}{\twitht{\parens{\tforall{\anno{\tvar}{\kind}}{\type}}}{\tempty}}}}$}
      \end{prooftree}
