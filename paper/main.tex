  ...
  \begin{figure}
    \begin{mdframed}[backgroundcolor=none]
      ...
      \begin{prooftree}
          ...
          \AxiomC{$\subtype{\context}{\type_1}{\type_4}$}
  ...
  \begin{figure}
    \begin{mdframed}[backgroundcolor=none]
      ...
      \begin{prooftree}
        ...
        \UnaryInfC{$\subtype{\context}{\tempty}{\type}$}
      \end{prooftree}
      ...
      \begin{prooftree}
        ...
        \BinaryInfC{$\subtype{\context}{\tunion{\type_1}{\type_2}}{\type_3}$}
      \end{prooftree}

      \begin{prooftree}
          \AxiomC{}
        \RightLabel{(\textsc{ST-WeakeningLeft})}
        \UnaryInfC{$\subtype{\context}{\type_1}{\tunion{\type_1}{\type_2}}$}
      \end{prooftree}

      \begin{prooftree}
          \AxiomC{}
        \RightLabel{(\textsc{ST-WeakeningRight})}
        \UnaryInfC{$\subtype{\context}{\type_2}{\tunion{\type_1}{\type_2}}$}
      \end{prooftree}
