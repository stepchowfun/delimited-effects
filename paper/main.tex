    ...
    \begin{mdframed}[backgroundcolor=none]
      ...
      \begin{prooftree}
          \AxiomC{\Shortstack[c]{{$\opwellformed{\type_1}{\tvar_3}$}
            ...
            {$\tjudgment{\ceextend{\csextend{\context}{\anno{\tvar_1}{\karrow{\lstof{\color{red} \anno{\tvar_2^i}{\kind^i}}}{\keffect{\tvar_3}{\evar}{\type_1}}}}}{\anno{\evar}{\ptforall{\lstof{\color{red} \anno{\tvar_2^i}{\kind^i}}}{\type_1}}}}{\term}{\type_2}$}}}
