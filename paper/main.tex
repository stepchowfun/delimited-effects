  ...
  \section{Overview}
    ...
    \subsection{Semantics}
      ...
      \begin{figure}[H]
        \begin{mdframed}[backgroundcolor=none]
          \begin{center}
            \framebox{$\step{\term}{\term}$}
          \end{center}

          \medskip

          \begin{prooftree}
              \AxiomC{$\step{\term_1}{\term_2}$}
            \RightLabel{(\textsc{E-App1})}
            \UnaryInfC{$\step{\eApp{\term_1}{\term_3}}{\eApp{\term_2}{\term_3}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\step{\term_1}{\term_2}$}
            \RightLabel{(\textsc{E-App2})}
            \UnaryInfC{$\step{\eApp{\eValue}{\term_1}}{\eApp{\eValue}{\term_2}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{}
            \RightLabel{(\textsc{E-Beta})}
            \UnaryInfC{$\step{\eApp{\parens{\eAbs{\eVar}{\type}{\row}{\term}}}{\eValue}}{\substitute{\term}{\eVar}{\eValue}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\step{\term_1}{\term_2}$}
            \RightLabel{(\textsc{E-TApp})}
            \UnaryInfC{$\step{\eTApp{\term_1}{\type}}{\eTApp{\term_2}{\type}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{}
            \RightLabel{(\textsc{E-TBeta})}
            \UnaryInfC{$\step{\eTApp{\parens{\eTAbs{\tVar}{\kind}{\term}}}{\type}}{\substitute{\term}{\tVar}{\type}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\step{\term_1}{\term_2}$}
            \RightLabel{(\textsc{E-Reify1})}
            \UnaryInfC{$\step{\eReify{\term_1}{\tVar}{\term_3}}{\eReify{\term_2}{\tVar}{\term_3}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{}
            \RightLabel{(\textsc{E-Reify2})}
            \UnaryInfC{$\step{\eReify{\eValue}{\tVar}{\term}}{\substitute{\term}{\eReflect{\tVar}}{\eValue}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\step{\term_1}{\term_2}$}
            \RightLabel{(\textsc{E-Do1})}
            \UnaryInfC{$\step{\eDo{\eVar}{\term_1}{\term_3}}{\eDo{\eVar}{\term_2}{\term_3}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{}
            \RightLabel{(\textsc{E-Do2})}
            \UnaryInfC{$\step{\eDo{\eVar}{\eValue}{\term}}{\substitute{\term}{\eVar}{\eValue}}$}
          \end{prooftree}
