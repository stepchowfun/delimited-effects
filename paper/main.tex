        ...
        \begin{mdframed}[backgroundcolor=none]
          ...
          \begin{prooftree}
              \AxiomC{\Shortstack[c]{
                ...
                {$\hasKind{\cXExtend{\context}{\xVar}{\type_1}{\row_1}}{\parens{\tForAll{\tVar}{\kHandler}{\type_1}{\tUnion{\row_1}{\tSingleton{\tVar}{\xVar}}}}}{\kType}$}
                {$\hasType{\cEExtend{\cXExtend{\context}{\xVar}{\type_1}{\row_1}}{\eVar}{\parens{\tForAll{\tVar}{\kHandler}{\type_1}{\tUnion{\row_1}{\tSingleton{\tVar}{\xVar}}}}}{\tEmpty}}{\term}{\type_2}{\row_2}$}
              }}
            \RightLabel{(\textsc{T-Effect})}
            \UnaryInfC{$\hasType{\context}{\eEffect{\xVar}{\eVar}{\type_1}{\row_1}{\term}}{\type_2}{\row_2}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{\Shortstack[c]{
                {$\tVar \notin \dom{\context}$ \qquad $\apply{\context}{\xVar} = \tEmbellished{\type_1}{\row_1}$ \qquad $\hasKind{\context}{\type_2}{\kType}$ \qquad $\hasKind{\context}{\row_2}{\kRow}$}
                {$\hasType{\context}{\term_1}{\type_1}{\row_1}$ \qquad $\hasType{\cTExtend{\context}{\tVar}{\kHandler}}{\term_2}{\type_2}{\tUnion{\row_2}{\tSingleton{\tVar}{\xVar}}}$}
              }}
