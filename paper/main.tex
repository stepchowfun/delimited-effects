      ...
      \subsubsection{Typing}
        ...
        \begin{figure}[H]
          \begin{mdframed}[backgroundcolor=none]
            ...
            \begin{prooftree}
              ...
              \UnaryInfC{$\checkType{\context}{\effectMap}{\eAbs{\eVar}{\term}}{\parens{\tArrow{\type_2}{\row_2}{\type_1}{\row_1}}}{\row_3}{\hoistedSet_2}$}
            \end{prooftree}
            ...
            \caption{Type inference for the source language (part 1)}\label{fig:source_typing_1}
          \end{mdframed}
        \end{figure}
        ...
        \begin{figure}[H]
          \begin{mdframed}[backgroundcolor=none]
            ...
            \begin{prooftree}
                \AxiomC{$\checkOrInferType{\cTExtend{\context}{\eVar}{\type_1}{\row_1}}{\emExtend{\effectMap}{\tVar}{\type_1}{\row_1}}{\term}{\type_2}{\row_2}{\hoistedSet}$}
              \RightLabel{(\textsc{T-Effect})}
              \UnaryInfC{$\checkOrInferType{\context}{\effectMap}{\eEffect{\tVar}{\eVar}{\type_1}{\row_1}{\term}}{\type_2}{\row_2}{\hoistedSet}$}
            \end{prooftree}

            \begin{prooftree}
                \AxiomC{\Shortstack[c]{
                  {$\tEmbellished{\type_2}{\row_2} = \apply{\effectMap}{\tVar}$}
                  {$\type_3 = \substitute{\type_2}{\colorRow{\rSingleton{\tVar}}}{\colorRow{\row_1}}$}
                  {$\colorRow{\row_3} = \colorRow{\substitute{\row_2}{\rSingleton{\tVar}}{\row_1}}$}
                  {$\checkType{\context}{\effectMap}{\term_1}{\type_3}{\row_3}{\hoistedSet_1}$}
                  {$\checkOrInferType{\context}{\effectMap}{\term_2}{\type_1}{\rUnion{\row_1}{\rSingleton{\tVar}}}{\hoistedSet_2}$}
                  {$
                    \hoistedSet_3 =
                      \begin{cases}
              ...
              \UnaryInfC{$\checkOrInferType{\context}{\effectMap}{\eHandle{\tVar}{\term_1}{\term_2}}{\type_1}{\row_1}{\hUnion{\hoistedSet_2}{\hoistedSet_3}}$}
            \end{prooftree}

            \begin{prooftree}
                \AxiomC{$\checkType{\context}{\effectMap}{\term}{\type}{\row}{\hoistedSet}$}
              \RightLabel{(\textsc{T-Anno})}
              \UnaryInfC{$\inferType{\context}{\effectMap}{\eAnno{\term}{\type}}{\type}{\row}{\hoistedSet}$}
            \end{prooftree}
      ...
      \subsubsection{Typing}
        ...
        \begin{figure}[H]
          \begin{mdframed}[backgroundcolor=none]
            ...
            \caption{Typing rules for the target language}\label{fig:target_typing}
          \end{mdframed}
        \end{figure}
