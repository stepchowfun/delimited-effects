...
% Types
\newcommand\tembellished[2]{{#1}^{\color{violet}{#2}}}
\newcommand\proper{\tau}
\newcommand\tvar{\alpha}
\newcommand\tunit{1}
  ...
  \section{Overview}
    ...
    \subsection{Syntax and semantics}
        ...
        \begin{mdframed}[backgroundcolor=none]
          \begin{center}
            \begin{tabular}{l l l}
              ...
              & $\eunit$ & unit \\
              & $\evar$ & variable \\
              & $\eabs{\anno{\evar}{\proper}}{\term}$ & abstraction \\
              ...
              & $\tvar$ & type variable \\
              & $\tunit$ & unit type \\
              & $\tarrow{\proper}{\tembellished{\proper}{\row}}$ & arrow type \\
              ...
              & $\cextend{\context}{\anno{\evar}{\tembellished{\proper}{\row}}}$ & variable binding \\
              \\
              $\effectmap \Coloneqq$ & & effect map: \\
              & $\emempty$ & empty effect map \\
              & $\emextend{\effectmap}{\emmap{\effect}{\anno{\evar}{\tembellished{\proper}{\row}}}}$ & effect binding \\
            \end{tabular}
          \end{center}
      ...
      \begin{figure}[H]
        \begin{mdframed}[backgroundcolor=none]
          \begin{center}
            \framebox{$\hastype{\context}{\term}{\tembellished{\proper}{\row}}$}
          \end{center}
          ...
          \begin{prooftree}
              \AxiomC{$\apply{\context}{\evar} = \tembellished{\proper}{\row}$}
            \RightLabel{(\textsc{T-Variable})}
            \UnaryInfC{$\hastype{\context}{\evar}{\tembellished{\proper}{\row}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\hastype{\cextend{\context}{\anno{\evar}{\tembellished{\proper_1}{\rempty}}}}{\term}{\tembellished{\proper_2}{\row}}$}
            \RightLabel{(\textsc{T-Abstraction})}
            \UnaryInfC{$\hastype{\context}{\parens{\eabs{\anno{\evar}{\proper_1}}{\term}}}{\tembellished{\parens{\tarrow{\proper_1}{\tembellished{\proper_2}{\row_2}}}}{\rempty}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\hastype{\context}{\term_1}{\tembellished{\proper_1}{\row_1}}$}
              \AxiomC{$\hastype{\context}{\term_2}{\tembellished{\parens{\tarrow{\proper_1}{\tembellished{\proper_2}{\row_2}{}}}}{\row_3}}$}
            \RightLabel{(\textsc{T-Application})}
            \BinaryInfC{$\hastype{\context}{\eapp{\term_2}{\term_1}}{\tembellished{\proper_2}{\runion{\runion{\row_1}{\row_2}}{\row_3}}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\hastype{\context}{\term}{\tembellished{\proper}{\row}}$}
            \RightLabel{(\textsc{T-TypeAbstraction})}
            \UnaryInfC{$\hastype{\context}{\parens{\etabs{\tvar}{\term}}}{\tembellished{\parens{\tforall{\tvar}{\tembellished{\proper}{\row}}}}{\rempty}}$}
          \end{prooftree}

          \begin{prooftree}
            \AxiomC{$\hastype{\context}{\term}{\tembellished{\parens{\tforall{\tvar}{\tembellished{\proper_2}{\row_1}}}}{\row_2}}$}
            \RightLabel{(\textsc{T-TypeApplication})}
            \UnaryInfC{$\hastype{\context}{\etapp{\term}{\proper_1}}{\substitute{\tembellished{\proper_2}{\runion{\row_1}{\row_2}}}{\tvar}{\proper_1}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\hastype{\context}{\term}{\tembellished{\proper}{\row}}$}
            \RightLabel{(\textsc{T-RowAbstraction})}
            \UnaryInfC{$\hastype{\context}{\parens{\etabs{\rvar}{\term}}}{\tembellished{\parens{\tforall{\rvar}{\tembellished{\proper}{\row}}}}{\rempty}}$}
          \end{prooftree}

          \begin{prooftree}
            \AxiomC{$\hastype{\context}{\term}{\tembellished{\parens{\tforall{\rvar}{\tembellished{\proper}{\row_2}}}}{\row_3}}$}
            \RightLabel{(\textsc{T-RowApplication})}
            \UnaryInfC{$\hastype{\context}{\etapp{\term}{\row_1}}{\substitute{\tembellished{\proper}{\runion{\row_2}{\row_3}}}{\rvar}{\row_1}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\apply{\effectmap}{\effect} = \anno{\evar}{\tembellished{\proper_1}{\runion{\row_1}{\row_3}}}$}
              \AxiomC{$\hastype{\context}{\term_1}{\tembellished{\proper_1}{\row_1}}$}
              \AxiomC{$\hastype{\context}{\term_2}{\tembellished{\proper_2}{\row_2}}$}
            \RightLabel{(\textsc{T-Provide})}
            \TrinaryInfC{$\hastype{\context}{\eprovide{\effect}{\term_1}{\term_2}}{\tembellished{\proper_2}{\rdiff{\row_2}{\rsingleton{\effect}}}}$}
          \end{prooftree}
      ...
      \begin{figure}[H]
        \begin{mdframed}[backgroundcolor=none]
          \begin{center}
            \framebox{$\ewellformed{\emmap{\effect}{\tembellished{\proper}{\row}}}$}
          \end{center}
          ...
          \begin{prooftree}
            ...
            \UnaryInfC{$\ewellformed{\emmap{\effect}{\tembellished{\parens{\tarrow{\proper_1}{\tembellished{\proper_2}{\row_1}}}}{\row_2}}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\ewellformed{\emmap{\effect}{\tembellished{\proper_2}{\row_1}}}$}
          ...
          \begin{prooftree}
            ...
            \UnaryInfC{$\ewellformed{\emmap{\effect}{\tembellished{\parens{\tforall{\tvar}{\tembellished{\proper}{\row_1}}}}{\row_2}}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\ewellformed{\emmap{\effect}{\tembellished{\proper}{\row_1}}}$}
          ...
          \begin{prooftree}
            ...
            \UnaryInfC{$\ewellformed{\emmap{\effect}{\tembellished{\parens{\tforall{\rvar}{\tembellished{\proper}{\row_1}}}}{\row_2}}}$}
          \end{prooftree}
