        ...
        \begin{mdframed}[backgroundcolor=none]
          ...
          \begin{prooftree}
              \AxiomC{\Shortstack[c]{
                ...
                {$\mVar \notin \dom{\context}$ \qquad $\hasType{\cMExtend{\context}{\mVar}{\type_1}{\row_1}}{\term}{\type_2}{\row_2}$}
              }}
            \RightLabel{(\textsc{T-Mirror})}
            \UnaryInfC{$\hasType{\context}{\eMirror{\mVar}{\type_1}{\row_1}{\term}}{\type_2}{\row_2}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{\Shortstack[c]{
                {$\apply{\context}{\mVar} = \tEmbellished{\type_1}{\row_1}$ \qquad $\hasType{\context}{\term_1}{\type_1}{\row_1}$ \qquad $\hasKind{\context}{\type_2}{\kType}$ \qquad $\hasKind{\context}{\row_2}{\kRow}$}
                {$\tVar \notin \dom{\context}$ \qquad $\hasType{\cTExtend{\context}{\tVar}{\kReification}}{\term_2}{\type_2}{\tUnion{\row_2}{\tSingleton{\tVar}{\mVar}}}$}
              }}
            \RightLabel{(\textsc{T-Reify})}
            \UnaryInfC{$\hasType{\context}{\eReify{\term_1}{\tVar}{\mVar}{\term_2}}{\type_2}{\row_2}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\hasKind{\context}{\reification}{\kReification}$}
              \AxiomC{$\apply{\context}{\mVar} = \tEmbellished{\type}{\row}$}
            \RightLabel{(\textsc{T-Reflect})}
            \BinaryInfC{$\hasType{\context}{\eReflect{\reification}{\mVar}}{\type}{\tUnion{\row}{\tSingleton{\reification}{\mVar}}}$}
          \end{prooftree}
      ...
      \begin{figure}[H]
        \begin{mdframed}[backgroundcolor=none]
          ...
          \begin{prooftree}
            ...
            \BinaryInfC{$\hasKind{\context}{\tSingleton{\reification}{\mVar}}{\kRow}$}
          \end{prooftree}
