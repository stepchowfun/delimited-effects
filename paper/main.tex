...
\newcommand\eEffect[3]{\textbf{effect} \; #1 \; \textbf{where} \; #2 \; \textbf{in} \; #3}
  ...
  \section{Overview}
        ...
        \begin{mdframed}[backgroundcolor=none]
          \begin{center}
            \begin{tabular}{l l l}
              ...
              & $\eEffect{\effect}{\anno{\term}{\tEmbellished{\type}{\row}}}{\term}$ & effect declaration \\
    ...
    \subsection{Typing}
      ...
      \begin{figure}[H]
        \begin{mdframed}[backgroundcolor=none]
          \begin{center}
            \framebox{$\hasType{\context}{\effectMap}{\term}{\tEmbellished{\type}{\row}}$}
          \end{center}
          ...
          \begin{prooftree}
            ...
            \UnaryInfC{$\hasType{\context}{\effectMap}{\eUnit}{\tEmbellished{\tUnit}{\rEmpty}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\apply{\context}{\eVar} = \tEmbellished{\type}{\row}$}
            \RightLabel{(\textsc{T-Variable})}
            \UnaryInfC{$\hasType{\context}{\effectMap}{\eVar}{\tEmbellished{\type}{\row}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\hasType{\cExtend{\context}{\anno{\eVar}{\tEmbellished{\type_1}{\rEmpty}}}}{\effectMap}{\term}{\tEmbellished{\type_2}{\row_2}}$}
            \RightLabel{(\textsc{T-Abstraction})}
            \UnaryInfC{$\hasType{\context}{\effectMap}{\parens{\eAbs{\anno{\eVar}{\type_1}}{\term}}}{\tEmbellished{\parens{\tArrow{\type_1}{\tEmbellished{\type_2}{\row_2}}}}{\rEmpty}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\hasType{\context}{\effectMap}{\term_1}{\tEmbellished{\type_1}{\row_1}}$}
              \AxiomC{$\hasType{\context}{\effectMap}{\term_2}{\tEmbellished{\parens{\tArrow{\type_3}{\tEmbellished{\type_2}{\row_2}{}}}}{\row_3}}$}
              \AxiomC{$\subtype{\type_1}{\type_3}$}
            \RightLabel{(\textsc{T-Application})}
            \TrinaryInfC{$\hasType{\context}{\effectMap}{\eApp{\term_2}{\term_1}}{\tEmbellished{\type_2}{\rUnion{\rUnion{\row_1}{\row_2}}{\row_3}}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\hasType{\cExtend{\context}{\anno{\eVar}{\tEmbellished{\type_1}{\row_1}}}}{\emExtend{\effectMap}{\emMap{\effect}{\eVar}}}{\term}{\tEmbellished{\type_2}{\row_2}}$}
              \AxiomC{$\eWellFormed{\effect}{\tEmbellished{\type_1}{\row_1}}$}
            \RightLabel{(\textsc{T-Effect})}
            \BinaryInfC{$\hasType{\context}{\effectMap}{\eEffect{\effect}{\anno{\eVar}{\tEmbellished{\type_1}{\row_1}}}{\term}}{\tEmbellished{\type_2}{\row_2}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{\Shortstack[c]{
                {$\hasType{\context}{\effectMap}{\term_1}{\tEmbellished{\type_1}{\row_1}}$}
                {$\hasType{\context}{\effectMap}{\term_2}{\tEmbellished{\type_2}{\row_2}}$}
                {$\hasType{\context}{\effectMap}{\apply{\effectMap}{\effect}}{\tEmbellished{\type_3}{\row_3}}$}
            ...
            \UnaryInfC{$\hasType{\context}{\effectMap}{\eHandle{\effect}{\overline{\effect_i}}{\term_1}{\term_2}}{\tEmbellished{\type_2}{\rUnion{\parens{\rDiff{\row_2}{\rSingleton{\effect}}}}{\effect_i}}}$}
          \end{prooftree}
      ...
      \begin{figure}[H]
        \begin{mdframed}[backgroundcolor=none]
          \begin{center}
            \framebox{$\eWellFormed{\effect}{\tEmbellished{\type}{\row}}$}
          \end{center}
          ...
          \begin{prooftree}
            ...
            \RightLabel{(\textsc{EWF-Unit})}
            \UnaryInfC{$\eWellFormed{\effect}{\tEmbellished{\tUnit}{\row}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\eWellFormed{\effect}{\tEmbellished{\type_2}{\row_1}}$}
            \RightLabel{(\textsc{EWF-Arrow1})}
            \UnaryInfC{$\eWellFormed{\effect}{\tEmbellished{\parens{\tArrow{\type_1}{\tEmbellished{\type_2}{\row_1}}}}{\row_2}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\subrow{\rSingleton{\effect}}{\row_2}$}
            \RightLabel{(\textsc{EWF-Arrow2})}
            \UnaryInfC{$\eWellFormed{\effect}{\tEmbellished{\parens{\tArrow{\type_1}{\tEmbellished{\type_2}{\row_1}}}}{\row_2}}$}
          \end{prooftree}
