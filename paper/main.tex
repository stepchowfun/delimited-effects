...
\begin{document}
  ...
  \begin{figure}
    \begin{mdframed}[backgroundcolor=none]
      ...
      \begin{prooftree}
          \AxiomC{$\hastype{\context}{\term_1}{\type_1}$}
          \AxiomC{$\hastype{\context}{\term_2}{\tembellished{\type_2}{\type_3}{\type_4}}$}
          \AxiomC{$\apply{\coeffectmap}{\coeffect} = \anno{\evar}{\type_5}$}
          \AxiomC{$\subtype{\type_1}{\type_5}$}
        \RightLabel{(\textsc{T-CoProvide})}
        \QuaternaryInfC{$\hastype{\context}{\ecoprovide{\coeffect}{\term_1}{\term_2}}{\tembellished{\type_2}{\type_3}{\tunion{\type_4}{\coeffect}}}$}
      \end{prooftree}
  ...
  \begin{figure}
    \begin{mdframed}[backgroundcolor=none]
      ...
      \begin{prooftree}
          \AxiomC{$\apply{\coeffectmap}{\coeffect} = \anno{\evar}{\type}$}
        \RightLabel{(\textsc{K-SingletonCoeffectRow})}
        \UnaryInfC{$\hastype{\context}{\tsingleton{\coeffect}}{\krow}$}
      \end{prooftree}
  ...
  \begin{figure}
    \begin{mdframed}[backgroundcolor=none]
      ...
      \begin{prooftree}
        ...
        \BinaryInfC{$\wellformed{\context}{\emmap{\effect}{\tembellished{\tunit}{\type}{\tempty}}}$}
      \end{prooftree}
      ...
      \begin{prooftree}
          ...
          \AxiomC{$\hastype{\context}{\type_1}{\ktembellished}$}
          \AxiomC{$\hastype{\context}{\type_2}{\ktembellished}$}
        \RightLabel{(\textsc{EWF-Arrow})}
        \TrinaryInfC{$\wellformed{\context}{\emmap{\effect}{\tembellished{\parens{\tarrow{\type_1}{\type_2}}}{\tempty}{\tempty}}}$}
      \end{prooftree}

      \begin{prooftree}
          \AxiomC{$\wellformed{\cextend{\context}{\anno{\tvar}{\kind}}}{\emmap{\effect}{\type}}$}
          \AxiomC{$\hastype{\cextend{\context}{\anno{\tvar}{\kind}}}{\type}{\ktembellished}$}
        \RightLabel{(\textsc{EWF-ForAll})}
        \BinaryInfC{$\wellformed{\context}{\emmap{\effect}{\tembellished{\parens{\tforall{\anno{\tvar}{\kind}}{\type}}}{\tempty}{\tempty}}}$}
      \end{prooftree}
  ...
  \begin{figure}
    \begin{mdframed}[backgroundcolor=none]
      \begin{center}
        \framebox{$\wellformed{\context}{\emmap{\coeffect}{\type}}$}
      \end{center}
      ...
      \begin{prooftree}
          \AxiomC{$\hastype{\context}{\type_1}{\kproper}$}
          \AxiomC{$\hastype{\context}{\type_2}{\ktembellished}$}
        \RightLabel{(\textsc{CWF-Arrow})}
        \BinaryInfC{$\wellformed{\context}{\emmap{\coeffect}{\tembellished{\parens{\tarrow{\tembellished{\type_1}{\tempty}{\tsingleton{\coeffect}}}{\type_2}}}{\tempty}{\tempty}}}$}
      \end{prooftree}
