...
% Types
\newcommand\tembellished[3]{{#1}^{\textcolor{violet}{#2}}_{\textcolor{violet}{#3}}}
\newcommand\type{\tau}
\newcommand\tvar{\alpha}
\newcommand\tunit{1}
  ...
  \section{Overview}
    ...
    \subsection{Syntax and semantics}
      ...
      \begin{figure}[H]
        \begin{mdframed}[backgroundcolor=none]
          \begin{center}
            \framebox{$\hastype{\context}{\term}{\tembellished{\type}{\row}{\row}}$}
          \end{center}

          \medskip

          \begin{prooftree}
              \AxiomC{$\hastype{\context}{\term}{\tembellished{\type}{\row_1}{\row_2}}$}
            \RightLabel{(\textsc{T-Bang})}
            \UnaryInfC{$\hastype{\context}{\ebang{\term}}{\tembellished{\type}{\rempty}{\runion{\row_1}{\row_2}}}$}
          \end{prooftree}
          ...
          \begin{prooftree}
            ...
            \UnaryInfC{$\hastype{\context}{\evar}{\tembellished{\type}{\row}{\rempty}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\hastype{\cextend{\context}{\anno{\evar}{\tembellished{\type_1}{\rempty}{}}}}{\term}{\tembellished{\type_2}{\row_1}{\row_2}}$}
            \RightLabel{(\textsc{T-Abstraction})}
            \UnaryInfC{$\hastype{\context}{\parens{\eabs{\anno{\evar}{\type_1}}{\term}}}{\tembellished{\parens{\tarrow{\type_1}{\tembellished{\type_2}{\row_2}{}}}}{\row_1}{\rempty}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\hastype{\context}{\term_1}{\tembellished{\type_1}{\row_1}{\row_2}}$}
              \AxiomC{$\hastype{\context}{\term_2}{\tembellished{\parens{\tarrow{\type_1}{\tembellished{\type_2}{\row_3}{}}}}{\row_4}{\row_5}}$}
            \RightLabel{(\textsc{T-Application})}
            \BinaryInfC{$\hastype{\context}{\eapp{\term_2}{\term_1}}{\tembellished{\type_2}{\runion{\runion{\row_1}{\row_3}}{\row_4}}{\runion{\row_2}{\row_5}}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\hastype{\context}{\term}{\tembellished{\type}{\row_1}{\row_2}}$}
            \RightLabel{(\textsc{T-TypeAbstraction})}
            \UnaryInfC{$\hastype{\context}{\parens{\etabs{\tvar}{\term}}}{\tembellished{\parens{\tforall{\tvar}{\tembellished{\type}{\row_2}{}}}}{\row_1}{\rempty}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\hastype{\context}{\term}{\tembellished{\parens{\tforall{\tvar}{\tembellished{\type_2}{\row_1}{}}}}{\row_2}{\row_3}}$}
            \RightLabel{(\textsc{T-TypeApplication})}
            \UnaryInfC{$\hastype{\context}{\etapp{\term}{\type_1}}{\tembellished{\substitute{\type_2}{\tvar}{\type_1}}{\runion{\row_1}{\row_2}}{\row_3}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\hastype{\context}{\term}{\tembellished{\type}{\row_1}{\row_2}}$}
            \RightLabel{(\textsc{T-RowAbstraction})}
            \UnaryInfC{$\hastype{\context}{\parens{\etabs{\rvar}{\term}}}{\tembellished{\parens{\tforall{\rvar}{\tembellished{\type}{\row_2}{}}}}{\row_1}{\rempty}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\hastype{\context}{\term}{\tembellished{\parens{\tforall{\rvar}{\tembellished{\type}{\row_2}{}}}}{\row_3}{\row_4}}$}
            \RightLabel{(\textsc{T-RowApplication})}
            \UnaryInfC{$\hastype{\context}{\etapp{\term}{\row_1}}{\tembellished{\substitute{\type}{\rvar}{\row_1}}{\substitute{\parens{\runion{\row_2}{\row_3}}}{\rvar}{\row_1}}{\row_4}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\apply{\effectmap}{\effect} = \anno{\evar}{\tembellished{\type_1}{\runion{\row_1}{\row_3}}{}}$}
              \AxiomC{$\hastype{\context}{\term_1}{\tembellished{\type_1}{\row_1}{\row_2}}$}
              \AxiomC{$\hastype{\context}{\term_2}{\tembellished{\type_2}{\row_3}{\row_4}}$}
            \RightLabel{(\textsc{T-Provide})}
            \TrinaryInfC{$\hastype{\context}{\eprovide{\effect}{\term_1}{\term_2}}{\tembellished{\type_2}{\rdiff{\row_3}{\rsingleton{\effect}}}{\runion{\row_2}{\row_4}}}$}
          \end{prooftree}
