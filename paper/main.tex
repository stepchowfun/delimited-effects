...
\newcommand\ecowellformed[1]{#1 \; \text{well-formed coeffect}}
    ...
    \subsection{Syntax and semantics}
      ...
      \begin{figure}[H]
        \begin{mdframed}[backgroundcolor=none]
          ...
          \begin{prooftree}
              \AxiomC{$\hastype{\cextend{\context}{\anno{\evar}{\tembellished{\proper_1}{\rempty}{\row_1}}}}{\term}{\tembellished{\proper_2}{\row_2}{\row_3}}$}
            \RightLabel{(\textsc{T-Abstraction})}
            \UnaryInfC{$\hastype{\context}{\parens{\eabs{\anno{\evar}{\tembellished{\proper_1}{}{\row_1}}}{\term}}}{\tembellished{\parens{\tarrow{\tembellished{\proper_1}{}{\row_1}}{\tembellished{\proper_2}{\row_2}{}}}}{\rempty}{\rempty}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\hastype{\context}{\term_1}{\tembellished{\proper_1}{\row_1}{\runion{\row_4}{\row_5}}}$}
              \AxiomC{$\hastype{\context}{\term_2}{\tembellished{\parens{\tarrow{\tembellished{\proper_1}{}{\row_4}}{\tembellished{\proper_2}{\row_2}{}}}}{\row_3}{\row_6}}$}
          ...
          \begin{prooftree}
            \AxiomC{$\hastype{\context}{\term}{\tembellished{\parens{\tforall{\tvar}{\tembellished{\proper_2}{\row_1}{}}}}{\row_2}{\rempty}}$}
            \RightLabel{(\textsc{T-TypeApplication})}
            \UnaryInfC{$\hastype{\context}{\etapp{\term}{\proper_1}}{\substitute{\tembellished{\proper_2}{\runion{\row_1}{\row_2}}{\rempty}}{\tvar}{\proper_1}}$}
          \end{prooftree}
          ...
          \begin{prooftree}
            \AxiomC{$\hastype{\context}{\term}{\tembellished{\parens{\tforall{\rvar}{\tembellished{\proper}{\row_2}{}}}}{\row_3}{\rempty}}$}
            \RightLabel{(\textsc{T-RowApplication})}
            \UnaryInfC{$\hastype{\context}{\etapp{\term}{\row_1}}{\substitute{\tembellished{\proper}{\runion{\row_2}{\row_3}}{\rempty}}{\rvar}{\row_1}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\apply{\effectmap}{\effect} = \anno{\evar}{\tembellished{\proper_1}{\runion{\row_1}{\row_3}}{\row_2}}$}
              \AxiomC{$\hastype{\context}{\term_1}{\tembellished{\proper_1}{\row_3}{\runion{\row_2}{\row_4}}}$}
              \AxiomC{$\hastype{\context}{\term_2}{\tembellished{\proper_2}{\row_5}{\row_6}}$}
            \RightLabel{(\textsc{T-Provide})}
            \TrinaryInfC{$\hastype{\context}{\eprovide{\effect}{\term_1}{\term_2}}{\tembellished{\proper_2}{\rdiff{\row_5}{\rsingleton{\effect}}}{\row_6}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\apply{\coeffectmap}{\effect} = \anno{\evar}{\tembellished{\proper_1}{\runion{\row_1}{\row_3}}{\row_2}}$}
              \AxiomC{$\hastype{\context}{\term_1}{\tembellished{\proper_1}{\row_3}{\runion{\row_2}{\row_4}}}$}
              \AxiomC{$\hastype{\context}{\term_2}{\tembellished{\proper_2}{\row_5}{\row_6}}$}
            \RightLabel{(\textsc{T-CoProvide})}
            \TrinaryInfC{$\hastype{\context}{\ecoprovide{\effect}{\term_1}{\term_2}}{\tembellished{\proper_2}{\row_5}{\runion{\row_6}{\rsingleton{\effect}}}}$}
          \end{prooftree}
      ...
      \begin{figure}[H]
        \begin{mdframed}[backgroundcolor=none]
          \begin{center}
            \framebox{$\ewellformed{\emmap{\effect}{\tembellished{\proper}{\row}{\row}}}$}
          \end{center}

          \medskip

          \begin{prooftree}
              \AxiomC{$\effect \in \row_1$}
            \RightLabel{(\textsc{WFE-Unit})}
            \UnaryInfC{$\ewellformed{\emmap{\effect}{\tembellished{\tunit}{\row_1}{\row_2}}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\effect \in \row_3$}
            \RightLabel{(\textsc{WFE-Arrow1})}
            \UnaryInfC{$\ewellformed{\emmap{\effect}{\tembellished{\parens{\tarrow{\tembellished{\proper_1}{}{\row_1}}{\tembellished{\proper_2}{\row_2}{}}}}{\row_3}{\row_4}}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\ewellformed{\emmap{\effect}{\tembellished{\proper_2}{\row_2}{\rempty}}}$}
          ...
          \begin{prooftree}
            ...
            \UnaryInfC{$\ewellformed{\emmap{\effect}{\tembellished{\parens{\tforall{\tvar}{\tembellished{\proper}{\row_1}{}}}}{\row_2}{\row_3}}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\ewellformed{\emmap{\effect}{\tembellished{\proper}{\row_1}{\rempty}}}$}
          ...
          \begin{prooftree}
            ...
            \UnaryInfC{$\ewellformed{\emmap{\effect}{\tembellished{\parens{\tforall{\rvar}{\tembellished{\proper}{\row_1}{}}}}{\row_2}{\row_3}}}$}
          \end{prooftree}
      ...
      \begin{figure}[H]
        \begin{mdframed}[backgroundcolor=none]
          \begin{center}
            \framebox{$\ecowellformed{\emmap{\effect}{\tembellished{\proper}{\row}{\row}}}$}
          \end{center}
          ...
          \begin{prooftree}
              \AxiomC{$\effect \in \row_1$}
            \RightLabel{(\textsc{WFC-Arrow1})}
            \UnaryInfC{$\ecowellformed{\emmap{\effect}{\tembellished{\parens{\tarrow{\tembellished{\proper}{}{\row_1}}{\tembellished{\proper}{\row_2}{}}}}{\row_3}{\row_4}}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\ecowellformed{\emmap{\effect}{\tembellished{\proper}{\row_2}{\rempty}}}$}
            \RightLabel{(\textsc{WFC-Arrow2})}
            \UnaryInfC{$\ecowellformed{\emmap{\effect}{\tembellished{\parens{\tarrow{\tembellished{\proper}{}{\row_1}}{\tembellished{\proper}{\row_2}{}}}}{\row_3}{\row_4}}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\ecowellformed{\emmap{\effect}{\tembellished{\proper}{\row_1}{\rempty}}}$}
            \RightLabel{(\textsc{WFC-ForAll1})}
            \UnaryInfC{$\ecowellformed{\emmap{\effect}{\tembellished{\parens{\tforall{\tvar}{\tembellished{\proper}{\row_1}{}}}}{\row_2}{\row_3}}}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\ecowellformed{\emmap{\effect}{\tembellished{\proper}{\row_1}{\rempty}}}$}
            \RightLabel{(\textsc{WFC-ForAll2})}
            \UnaryInfC{$\ecowellformed{\emmap{\effect}{\tembellished{\parens{\tforall{\rvar}{\tembellished{\proper}{\row_1}{}}}}{\row_2}{\row_3}}}$}
          \end{prooftree}
