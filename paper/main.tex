    ...
    \begin{mdframed}[backgroundcolor=none]
      \begin{center}
        \begin{tabular}{l l l}
          ...
          $\type \Coloneqq$ & & types: \\
          & $\tvar$ & type variable \\
          & $\twithr{\tunit}{\row}$ & unit type \\
          & $\twithr{(\tarrow{\type}{\type})}{\row}$ & arrow type \\
          & $\twithr{(\tforall{\tvar}{\type})}{\row}$ & quantified type \\
          \\
  ...
  \begin{figure}
    \begin{mdframed}[backgroundcolor=none]
      ...
      \begin{prooftree}
        ...
        \UnaryInfC{$\tjudgment{\context}{\eunit}{\twithr{\tunit}{\rempty}}$}
      \end{prooftree}
      ...
      \begin{prooftree}
        ...
        \UnaryInfC{$\tjudgment{\context}{\parens{\eabs{\anno{\evar}{\type_1}}{\term}}}{\twithr{\parens{\tarrow{\type_1}{\type_2}}}}{\rempty}$}
      \end{prooftree}

      \begin{prooftree}
          \AxiomC{\Shortstack[c]{{$\tjudgment{\context}{\term_1}{\twithr{\type_1}{\row_1}}$}
            {$\tjudgment{\context}{\term_2}{\twithr{\parens{\tarrow{\twithr{\type_2}{\row_2}}{\twithr{\type_3}{\row_3}}}}{\row_4}}$}
            {$\subtype{\context}{\twithr{\type_1}{\row_1}}{\twithr{\type_2}{\row_2}}$}}}
        \RightLabel{(\textsc{T-Application})}
        \UnaryInfC{$\tjudgment{\context}{\eapp{\term_2}{\term_1}}{\twithr{\type_3}{\runion{\row_3}{\row_4}}}$}
      \end{prooftree}

      \begin{prooftree}
          \AxiomC{$\tjudgment{\context}{\term}{\type}$}
        \RightLabel{(\textsc{T-TypeAbstraction})}
        \UnaryInfC{$\tjudgment{\context}{\parens{\etabs{\tvar}{\term}}}{\twithr{\parens{\tforall{\tvar}{\type}}}}{\rempty}$}
      \end{prooftree}

      \begin{prooftree}
          \AxiomC{$\tjudgment{\context}{\term}{\twithr{\parens{\tforall{\tvar}{\type_2}}}}{\rempty}$}
      ...
      \begin{prooftree}
          \AxiomC{\Shortstack[c]{{$\opwellformed{\context}{\type_1}{\evar_2}$}
            {$\evar_1 \notin \freevars{\type_2}$}
            {$\tjudgment{\ceextend{\csextend{\context}{\anno{\evar_1}{\twithr{\parens{\tforall{\lstof{\tvar^i}}{\teffect{\evar_2}{\evar_3}{\type_1}}}}{\rempty}}}}{\anno{\evar_3}{\twithr{\parens{\tforall{\lstof{\tvar^i}}{\sub{\type_1}{\evar_2}{\etapp{\evar_1}{\lstof{\tvar^i}}}}}}}{\rempty}}}{\term}{\type_2}$}}}
        \RightLabel{(\textsc{T-Effect})}
        \UnaryInfC{$\tjudgment{\context}{\parens{\eeffect{\evar_1}{\twithr{\parens{\tforall{\lstof{\tvar^i} }{\teffect{\evar_2}{\evar_3}{\type_1}}}}{\rempty}}{\term}}}{\type_2}$}
      \end{prooftree}

      \begin{prooftree}
          \AxiomC{\Shortstack[c]{{$\tjudgment{\context}{\term_1}{\type_1}$}
            {$\tjudgment{\context}{\term_2}{\twithr{\type}{\row}}$}
            {$\tjudgment{\context}{\term_3}{\teffect{\evar_2}{\evar_1}{\type_3}}$}
            {$\subtype{\context}{\type_1}{\sub{\type_3}{\evar_2}{\term_3}}$}}}
        \RightLabel{(\textsc{T-Provide})}
        \UnaryInfC{$\tjudgment{\context}{\parens{\eprovide{\term_3}{\evar_1}{\term_1}{\term_2}}}{\twithr{\type}\rdiff{\row}{\rsingleton{\term_3}}}$}
      \end{prooftree}
  ...
  \begin{figure}
    \begin{mdframed}[backgroundcolor=none]
      ...
      \begin{prooftree}
        ...
        \UnaryInfC{$\opwellformed{\context}{\twithr{\parens{\tarrow{\type_1}{\type_2}}}{\row}}{\evar}$}
      \end{prooftree}

      \begin{prooftree}
          \AxiomC{$\opwellformed{\context}{\type}{\evar}$}
        \RightLabel{(\textsc{WF-ForAll})}
        \UnaryInfC{$\opwellformed{\context}{\twithr{\parens{\tforall{\tvar}{\type}}}{\row}}{\evar}$}
      \end{prooftree}

      \begin{prooftree}
          \AxiomC{$\subtype{\context}{\rsingleton{\evar}}{\row}$}
        \RightLabel{(\textsc{WF-PureTypeWithEffects})}
        \UnaryInfC{$\opwellformed{\context}{\twithr{\type}{\row}}{\evar}$}
      \end{prooftree}
  ...
  \begin{figure}
    \begin{mdframed}[backgroundcolor=none]
      ...
      \begin{prooftree}
        ...
        \UnaryInfC{$\subsumes{\context}{\twithr{\tunit}{\row_1}}{\twithr{\tunit}{\row_2}}$}
      \end{prooftree}
      ...
      \begin{prooftree}
        ...
        \TrinaryInfC{$\subtype{\context}{\twithr{\parens{\tarrow{\type_1}{\type_2}}}{\row_1}}{\twithr{\parens{\tarrow{\type_3}{\type_4}}}{\row_2}}$}
      \end{prooftree}
      ...
      \begin{prooftree}
        ...
        \BinaryInfC{$\subtype{\context}{\twithr{\parens{\tforall{\tvar}{\type_1}}}{\row_1}}{\twithr{\parens{\tforall{\tvar}{\type_2}}}{\row_2}}$}
      \end{prooftree}
