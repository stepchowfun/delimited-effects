...
\newcommand\eEffect[4]{\textbf{effect} \; #1 \; \textbf{where} \; \tEmbellished{#2}{#3} \; \textbf{in} \; #4}
\newcommand\eHandle[4]{\textbf{handle} \; \hToX{#1}{#2} \; \textbf{with} \; #3 \; \textbf{in} \; #4}
\newcommand\eReflect[2]{\textbf{reflect} \; \hToX{#1}{#2}}
        ...
        \begin{mdframed}[backgroundcolor=none]
          \begin{center}
            \begin{tabular}{l l l}
              ...
              & $\eEffect{\xVar}{\type}{\row}{\term}$ & effect definition \\
              & $\eHandle{\tVar}{\xVar}{\term}{\term}$ & effect handler \\
              & $\eReflect{\tVar}{\xVar}$ & reflection \\
    ...
    \subsection{Typing}
      ...
      \begin{figure}[H]
        \begin{mdframed}[backgroundcolor=none]
          ...
          \begin{prooftree}
              \AxiomC{\Shortstack[c]{
                {$\hasKind{\context}{\type_1}{\kType}$ \qquad $\hasKind{\context}{\row_1}{\kRow}$ \qquad $\hasKind{\context}{\type_2}{\kType}$ \qquad $\hasKind{\context}{\row_2}{\kRow}$}
                {$\xVar \notin \dom{\context}$ \qquad $\hasType{\cXExtend{\context}{\xVar}{\type_1}{\row_1}}{\term}{\type_2}{\row_2}$}
              }}
            \RightLabel{(\textsc{T-Effect})}
            \UnaryInfC{$\hasType{\context}{\eEffect{\xVar}{\type_1}{\row_1}{\term}}{\type_2}{\row_2}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{\Shortstack[c]{
                {$\apply{\context}{\xVar} = \tEmbellished{\type_1}{\row_1}$ \qquad $\hasType{\context}{\term_1}{\type_1}{\row_1}$ \qquad $\hasKind{\context}{\type_2}{\kType}$ \qquad $\hasKind{\context}{\row_2}{\kRow}$}
                {$\tVar \notin \dom{\context}$ \qquad $\hasType{\cTExtend{\context}{\tVar}{\kHandler}}{\term_2}{\type_2}{\tUnion{\row_2}{\tSingleton{\tVar}{\xVar}}}$}
              }}
            \RightLabel{(\textsc{T-Handle})}
            \UnaryInfC{$\hasType{\context}{\eHandle{\tVar}{\xVar}{\term_1}{\term_2}}{\type_2}{\row_2}$}
          \end{prooftree}

          \begin{prooftree}
              \AxiomC{$\apply{\context}{\xVar} = \tEmbellished{\type}{\row}$}
            \RightLabel{(\textsc{T-Reflect})}
            \UnaryInfC{$\hasType{\context}{\eReflect{\tVar}{\xVar}}{\type}{\tUnion{\row}{\tSingleton{\tVar}{\xVar}}}$}
          \end{prooftree}
      ...
      \begin{figure}[H]
        \begin{mdframed}[backgroundcolor=none]
          ...
          \begin{prooftree}
              \AxiomC{$\hasKind{\context}{\handler}{\kHandler}$}
              \AxiomC{$\apply{\context}{\xVar} = \tEmbellished{\type}{\row}$}
            \RightLabel{(\textsc{K-Singleton})}
            \BinaryInfC{$\hasKind{\context}{\tSingleton{\handler}{\xVar}}{\kRow}$}
          \end{prooftree}
