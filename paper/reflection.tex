\section{Reflection and reification}
  ...
  \subsection{Semantics}
    ...
    This may come as a surprise, since no aspect of our system inherently relies on the semantics being call-by-value. The true problem is with substitution, as noted by \cite{amin17}.
