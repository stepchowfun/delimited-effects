...
\begin{document}
  ...
  \begin{figure}
    \begin{mdframed}[backgroundcolor=none]
      ...
      \begin{prooftree}
          \AxiomC{$\tjudgment{\ccontext}{\dcontext}{\eterm_2}{\twithx{\ttype}{\xsingleton{\xtapp{\xeffect}{\tx}}}}$}
          \AxiomC{$\tjudgment{\ccontext}{\dcontext}{\eterm_1}{\tx_2}$}
          \AxiomC{$\xusing{\xeffects}{\xtapp{\xeffect}{\tx}}{\tsub{\tx_1}{\lstof{\tvar}}{\lstof{\tx}}}{\tx_2}$}
          \AxiomC{$\deffect{\xeffect}{\lstof{\tvar}}{\evar}{\tx_1} \in \dcontext$}
        \RightLabel{(\textsc{T-Provide})}
        \QuaternaryInfC{$\tjudgment{\ccontext}{\dcontext}{\eprovide{\xtapp{\xeffect}{\tx}}{\xeffects}{\evar}{\eterm_1}{\eterm_2}}{\twithx{\ttype}{\xeffects}}$}
      \end{prooftree}
