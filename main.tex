  ...
  \begin{figure}
    \begin{mdframed}
      ...
      \begin{prooftree}
        ...
        \QuaternaryInfC{$\tjudgment{\ccontext}{\dextend{\dcontext}{\deffect{\xeffect}{\evar}{\tx_1}}}{\eprovide{\xeffect}{\evar}{\eterm_1}{\eterm_2}}{\twithx{\ttype}{\left(\xextend{\xeffects_1}{\xeffects_2}\right) - e}}$}
      \end{prooftree}
