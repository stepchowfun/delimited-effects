...
\newcommand\teffect[2]{\left\langle\anno{#1}{#2}\right\rangle}
...
\begin{document}
    ...
    \begin{mdframed}[backgroundcolor=none]
      \begin{center}
        \begin{tabular}{l l l}
          ...
          & $\eeffect{\evar}{\lstof{\anno{\svar}{\kkind}}}{\evar}{\sscheme}{\eterm}$ & effect declaration \\
          ...
          & $\teffect{\evar}{\sscheme}$ & type of an effect \\
          \\
          $\rrow \Coloneqq$ & & effect rows: \\
          & $\rempty$ & empty effect row \\
          & $\rsingleton{\eterm}$ & singleton effect row \\
  ...
  \begin{figure}
    \begin{mdframed}[backgroundcolor=none]
      ...
      \begin{prooftree}
          \AxiomC{$\tjudgment{\cextend{\cextend{\ccontext}{\anno{\evar_1}{\sabs{\lstof{\anno{\svar}{\kkind}}}{\teffect{\evar_2}{\sscheme_1}}}}}{\anno{\evar_2}{\ttforall{\lstof{\anno{\svar}{\kkind}}}{\sscheme_1}}}}{\eterm}{\sscheme_2}$}
          \AxiomC{$\xopwellformed{\evar_1}{\sscheme_1}$}
          \AxiomC{$\evar_1 \notin \dom{\ccontext}$}
          \AxiomC{$\evar_2 \notin \dom{\ccontext}$}
          \AxiomC{$\evar_2 \notin \sscheme_2$}
        \RightLabel{(\textsc{T-Effect})}
        \QuinaryInfC{$\tjudgment{\ccontext}{\parens{\eeffect{\evar_1}{\lstof{\anno{\svar}{\kkind}}}{\evar}{\sscheme_1}{\eterm}}}{\sscheme_2}$}
      \end{prooftree}
  ...
  \begin{figure}
    \begin{mdframed}[backgroundcolor=none]
      ...
      \begin{prooftree}
          \AxiomC{$\tjudgment{\ccontext}{\eterm}{\teffect{\evar}{\sscheme}}$}
        \RightLabel{(\textsc{K-SingletonEffectRow})}
        \UnaryInfC{$\tjudgment{\ccontext}{\rsingleton{\eterm}}{\teffect{\evar}{\sscheme}}$}
      \end{prooftree}
