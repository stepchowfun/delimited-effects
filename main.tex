  ...
  \begin{figure}
    \begin{mdframed}[backgroundcolor=none]
      ...
      \begin{prooftree}
        ...
        \UnaryInfC{$\xusing{\xunion{\xeffects_1}{\xeffects_2}}{\xeffect}{\twithx{\tunit}{\xextend{\xunion{\xeffects_3}{\xeffects_4}}{\xeffect}}}{\twithx{\tunit}{\xunion{\xeffects_1}{\xeffects_3}}}$}
      \end{prooftree}
      ...
      \begin{prooftree}
        ...
        \BinaryInfC{$\xusing{\xunion{\xunion{\xeffects_2}{\xeffects_3}}{\xeffects_4}}{\xeffect}{\twithx{\parens{\tarrow{\tx_1}{\tx_2}}}{\xextend{\xunion{\xeffects_1}{\xeffects_5}}{\xeffect}}}{\twithx{\parens{\tarrow{\tx_3}{\tx_4}}}{\xunion{\xeffects_1}{\xeffects_2}}}$}
      \end{prooftree}
