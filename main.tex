...
\begin{document}
  ...
  \begin{figure}
    \begin{mdframed}[backgroundcolor=none]
      ...
      \begin{prooftree}
          \AxiomC{$\xusing{\xunion{\xeffects_1}{\xeffects_2}}{\xeffect}{\tx_1}{\tx_3}$}
          \AxiomC{$\xusing{\xunion{\xeffects_1}{\xeffects_2}}{\xeffect}{\tx_2}{\tx_4}$}
        \RightLabel{(\textsc{EM-Arrow})}
        \BinaryInfC{$\xusing{\xunion{\xeffects_1}{\xeffects_2}}{\xeffect}{\twithx{\parens{\tarrow{\tx_1}{\tx_2}}}{\xunion{\xeffects_3}{\xeffects_4}}}{\twithx{\parens{\tarrow{\tx_3}{\tx_4}}}{\xsub{\xeffects_3}{\xeffect}{\xeffects_1}}}$}
      \end{prooftree}
  ...
  \begin{figure}
    \begin{mdframed}[backgroundcolor=none]
      ...
      \begin{prooftree}
        ...
        \UnaryInfC{$\xopwellformed{\xeffect}{\twithx{\tunit}{\xunion{\xeffects}{\xsingleton{\xeffect}}}}$}
      \end{prooftree}
  ...
  \begin{figure}
    \begin{mdframed}[backgroundcolor=none]
      ...
      \begin{prooftree}
        ...
        \QuinaryInfC{$\tjudgment{\ccontext}{\dcontext}{\eprovide{\xeffect}{\xeffects_2}{\evar}{\eterm_1}{\eterm_2}}{\twithx{\ttype}{\xunion{\xeffects_1 - e}{\xeffects_2}}}$}
      \end{prooftree}
